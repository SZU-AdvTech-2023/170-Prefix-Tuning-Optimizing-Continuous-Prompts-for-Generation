...
def main():
    ...
    if args.tuning_mode == 'finetune':
        ...
        print(config)
        model = model_class.from_pretrained(args.prefixModel_name_or_path, config=config, cache_dir=args.cache_dir)
    ...
    if args.task_mode == 'data2text':
        ...
        print(out_file_eval, '\n', gold_dir, '\n', curr_dir)
        os.system("python /yuhongf/wangyufeng/PrefixTuning/e2e-metrics/measure_scores.py "
        ...
        print("bash ../evaluation/run_eval_on_webnlg.sh "
                  "{} {} >> {}".format(curr_dir, tagging, out_file_eval))
        os.system("bash ../evaluation/run_eval_on_webnlg.sh "
                  "{} {} {}".format(curr_dir, tagging, out_file_eval))
        ...
        print(out_file_eval, '\n', gold_dir, '\n', curr_dir)
        tagging = os.path.basename(curr_dir)
        print("bash ../evaluation/run_eval_on_dart.sh "
                  "{} {}".format(curr_dir, tagging, out_file_eval))
        os.system("bash ../evaluation/run_eval_on_dart.sh "
                  "{} {}".format(curr_dir, tagging, out_file_eval))
