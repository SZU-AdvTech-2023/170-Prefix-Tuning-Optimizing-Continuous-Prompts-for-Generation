...
def main():
    ...
    if model_args.config_name:
        config = AutoConfig.from_pretrained(model_args.config_name, cache_dir=model_args.cache_dir,mirror='tuna')
    elif model_args.model_name_or_path:
        config = AutoConfig.from_pretrained(model_args.model_name_or_path, cache_dir=model_args.cache_dir,mirror='tuna')
    else:
        config = CONFIG_MAPPING[model_args.model_type]()
        logger.warning("You are instantiating a new config instance from scratch.")

    if model_args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained(model_args.tokenizer_name, cache_dir=model_args.cache_dir,mirror='tuna')
    elif model_args.model_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained(model_args.model_name_or_path, cache_dir=model_args.cache_dir,mirror='tuna')
    else:
        raise ValueError(
    ...
    if model_args.tuning_mode == 'adaptertune':
        ...
        print(data_args.finetuned_model_path)
        if model_args.model_name_or_path:
...
if __name__ == "__main__":
    print("into run_language_modeling_main")
    main()
