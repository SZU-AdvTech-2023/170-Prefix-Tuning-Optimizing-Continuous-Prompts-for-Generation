...
if __name__ == '__main__':
    ...
    ".format("../models/gpt2-medium-s3", Token_FILE, mode, control_mode, tuning_mode, gen_dir, eval_split)

    COMMANDLINE += app

    if tuning_mode == 'prefixtune' or tuning_mode == 'bothtune' or tuning_mode=="adaptertune" or tuning_mode=='finetune':
