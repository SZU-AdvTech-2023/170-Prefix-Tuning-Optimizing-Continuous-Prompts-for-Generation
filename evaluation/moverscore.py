...
if __name__ =='__main__':
    ...
    idf_dict_hyp = get_idf_dict(translations,1) # idf_dict_hyp = defaultdict(lambda: 1.)#translations is a list of candidate sentences
    idf_dict_ref = get_idf_dict(references,1) # idf_dict_ref = defaultdict(lambda: 1.)
