...
from transformers import AutoTokenizer, AutoModel,GPT2LMHeadModel,GPT2LMHeadModelAdapter
...
if os.environ.get('MOVERSCORE_MODEL'):
    ...
    model_name = '/yuhongf/wangyufeng/PrefixTuning/models/gpt2-medium-s3'
print(model_name)
